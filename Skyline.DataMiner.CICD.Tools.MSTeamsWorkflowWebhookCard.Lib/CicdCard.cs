namespace Skyline.DataMiner.CICD.Tools.MSTeamsWorkflowWebhookCard.Lib
{
	...
	public class CicdCard
	{
		...
		public void ApplyConfiguration(string nameOfPipeline, CicdResult result, string detailsOfResult = null, string pathToPipelineRun = null, string iconOfService = null)
		{
			...
			string iconOK = "https://skyline.be/skylicons/duotone/SuccesfullIdea_Duo_Light.png";
			string iconUnstable = "https://skyline.be/skylicons/duotone/Warning_Duo_Light.png";
			string iconWarning = "https://skyline.be/skylicons/duotone/FaultManager_Duo_Light.png";
			string iconFailure = "https://skyline.be/skylicons/duotone/Forbidden_Duo_Light.png";
			...
			if (!String.IsNullOrEmpty(iconOfService))
			{
			...
			if (!String.IsNullOrEmpty(pathToPipelineRun))
			{
			...
			if (!String.IsNullOrEmpty(detailsOfResult))
			{
